...
const DICT = {
  it: {
    ...
    'home.subSets': '{sets} serie · {n} esercizi · a casa tua',
    'home.stat.duration': 'Durata',
    'home.stat.rounds': 'Giri',
    'home.stat.sets': 'Serie',
    ...
    'phase.circuitSetsSub': '{n} esercizi · a serie',
    'phase.setsNote': 'Tutte le serie di un esercizio, poi si cambia',
    ...
    'wk.set': 'SERIE {s} / {n}',
    'wk.repsUnit': 'RIP',
    'wk.repsGoal': '{n} ripetizioni · premi Avanti a fine serie',
    'wk.tip.restSet': 'Recupero tra le serie.',
    'wk.tip.restEx': 'Riposo, poi cambia esercizio.',
    ...
    'editor.restSets': 'Recupero tra le serie',
    'editor.restExercise': 'Recupero tra esercizi',
    'editor.sets': 'Serie',
    'editor.setsUnit': 'serie',
    ...
    'fav.metaSets': "⏱ {min}' · 🏋️ {sets} serie · 🏃 {ex} esercizi",
    'fav.saved': '✓ Salvato',
  ...
  en: {
    ...
    'home.subSets': '{sets} sets · {n} exercises · at home',
    ...
    'phase.circuitSetsSub': '{n} exercises · straight sets',
    'phase.setsNote': 'All sets of an exercise, then move on',
    ...
    'wk.set': 'SET {s} / {n}',
    'wk.repsUnit': 'REPS',
    'wk.repsGoal': '{n} reps · press Next when done',
    'wk.tip.restSet': 'Rest between sets.',
    'wk.tip.restEx': 'Rest, then next exercise.',
    ...
    'editor.restSets': 'Rest between sets',
    'editor.restExercise': 'Rest between exercises',
    'editor.sets': 'Sets',
    'editor.setsUnit': 'sets',
    ...
    'fav.metaSets': "⏱ {min}' · 🏋️ {sets} sets · 🏃 {ex} exercises",
    'fav.saved': '✓ Saved',
